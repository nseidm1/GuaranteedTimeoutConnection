...
public class GuaranteedTimeoutConnection
{
     ...
     * to specify a custom socket factory this is needed. Be cautious that the constructor creates a Handler 
     * so either call the constructor from the UI thread or use Looper properly.
     * 
     * @param milliseconds
